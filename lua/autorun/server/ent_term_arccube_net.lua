...
net.Receive("arccube_property", function(len, ply)
    ...
    local props = {
        ...
        segments = function(v) ent:SetArcSegments(math.Clamp(v, 3, 64)) end,
        jitter = function(v) ent:SetArcJitter(math.Clamp(v, 1, 500)) end,
        ...
        branchcount = function(v) ent:SetArcBranchCount(math.Clamp(v, 0, 10)) end,
